		...
		<div class="col-lg-12">
				...
				if(user != null){
						if(user.getUser_role() == 2){
							...
							<button type="button" class="btn btn-default" onclick="location.href='/businessStrategy/update.do?board_idx=${detail.board_idx}'">수정</button>
							<button type="button" class="btn btn-default" onclick="location.href='/businessStrategy/deleteProc.do?board_idx=${detail.board_idx}'">삭제</button>
							<% }
						}else{%>
							<button type="button" class="btn btn-default" onclick="location.href='/businessStrategy/update.do?board_idx=${detail.board_idx}'">수정</button>
							<button type="button" class="btn btn-default" onclick="location.href='/businessStrategy/deleteProc.do?board_idx=${detail.board_idx}'">삭제</button>	
	...
	<script>
		$(document).ready(function() {
			$('#btn_save').on("click",function(e) {
				...
				$("#frm").attr("action","/businessStrategy/insertReply.do?board_idx="+ board_idx + "&f_type=SE");
