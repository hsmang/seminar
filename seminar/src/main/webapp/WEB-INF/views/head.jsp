...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <!-- Custom CSS -->
    <link href="/resources/modern-business/css/modern-business.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/resources/modern-business/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
