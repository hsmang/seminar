...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Business Strategy <small>Subheading</small></h1>
			<ol class="breadcrumb">
				<li><a href="/index.do">Home</a></li>
				<li class="active">Business Strategy</li>
			</ol>
		</div>
	</div>
	<br>
	...
	<%
		if(user != null){
	%><button type="button" id="btn_insert" class="btn btn-default" onclick="location.href='/businessStrategy/insert.do'" >작성</button>
	<%} %>
	</form>
	<hr>
