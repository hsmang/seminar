...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Business Admin  <small>Subheading</small></h1>
			<ol class="breadcrumb">
	...
	<%
		if(user != null){
	%><button type="button" id="btn_insert" class="btn btn-default" onclick="location.href='/businessAdmin/insert.do'" >작성</button>
	<%} %>
	</form>
	<hr>
