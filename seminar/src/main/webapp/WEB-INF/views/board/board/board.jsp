...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">メンバー専用</h1>
			<ol class="breadcrumb">
				...
				<c:when test="${fn:length(boardList) > 0}">
					<c:forEach items="${boardList }" var="list">
						<tr>
							...
							<td><a href="/board/detail.do?board_idx=${list.board_idx }&f_type=BO" id="subject">${list.board_subject }</a></td>
	...
	<%
		if(user != null){
	%><button type="button" id="btn_insert" class="btn btn-default" onclick="location.href='/board/insert.do'" >作成</button>
	<%} %>
	</form>
	<hr>
	...
	function fn_search(){
		...
		if(search_value == ""){
			...
			$("#search_form").attr("action", "/board.do?pageNumber=1&pageSize=10");
			search_form.submit();
		}
	}
	
	function fn_goList(){
		location.href='/board.do?pageNumber=1&pageSize=10';
	}
