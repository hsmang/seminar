...
public class BusinessAdminController {
	///////////////////////////////////////////////////////////////////////////////
	@Resource(name = "businessAdminService")
	private BoardService boardService;

	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessAdmin.do")
	public ModelAndView getBusinessAdminBoardList(String pageNumber, String pageSize, String search_value,
		...
		if (search_value == null && search_type == null) {
			...
			ModelAndView mv = new ModelAndView("/board/businessAdmin/businessAdmin");
	...
	@RequestMapping(value = "/businessAdmin/detail.do", method = RequestMethod.GET)
	public ModelAndView getBusinessAdminBoardDetail(int board_idx, String f_type, HttpSession session,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView mv = new ModelAndView("/board/businessAdmin/businessAdmin_detail");
	...
	@RequestMapping(value = "/businessAdmin/fileDownload.do")
	public ModelAndView fileDownload_BusinessAdmin(@RequestParam("filePath") String filePath) throws Exception {
		String path = filePath;
		File downloadFile = new File(path);
		return new ModelAndView("fileDownloadView", "downloadFile", downloadFile);
	}

	@RequestMapping(value = "/businessAdmin/insertReply.do")
	public String insertBusinessAdminReply(HttpSession session, ReplyVO reply, HttpServletRequest request, int board_idx, String f_type)
			throws Exception {
		UserVO user = (UserVO) session.getAttribute("user");
		reply.setBoard_idx(board_idx);
		reply.setF_type(f_type);
		...
		return "redirect:/businessAdmin/detail.do?board_idx=" + board_idx + "&f_type=" + f_type;
	}
	
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessAdmin/deleteReplyProc.do")
		public String deleteBusinessAdminReply(HttpServletRequest request, int reply_idx) throws Exception {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessAdmin/update.do", method = RequestMethod.GET)
	public ModelAndView updateBusinessAdminBoardDetail(int board_idx) throws Exception {
		ModelAndView mv = new ModelAndView("/board/businessAdmin/businessAdmin_update");
	 ...
	 * boardVO 매개변수로 다 받음
	 */
	@RequestMapping(value = "/businessAdmin/updateProc.do")
	public String updateProcBusinessAdminBoardDetail(BoardVO board, HttpServletRequest request) throws Exception {

		boardService.updateBoardDetail(board);

		return "redirect:/businessAdmin.do";
	}

	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessAdmin/deleteProc.do")
	public String deleteBBusinessAdminBoardDetail(int board_idx) throws Exception {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessAdmin/insert.do")
	public String insertBusinessAdminBoard() throws Exception {

		return "/board/businessAdmin/businessAdmin_insert";
	}

	///////////////////////////////////////////////////////////////////////////////

	@RequestMapping(value = "/businessAdmin/insertProc.do")
	public String insertProcBusinessAdminBoard(BoardVO board, HttpServletRequest request, HttpSession session)
			throws Exception {
		UserVO user = (UserVO) session.getAttribute("user");
	...
	@RequestMapping(value = "/businessAdmin/fileUpload.do")
	@ResponseBody
	public Map<String, String> fileUpload_BusinessAdmin(HttpServletRequest request, FileVO filevo, String board_idx)
			throws Exception {
	...
	@RequestMapping(value = "/businessAdmin/fileDelete.do")
	@ResponseBody
	public Map<String, String> fileDelete_BusinessAdmin(String name, int index) throws Exception {
		FileVO fileinfo = new FileVO();
	...
	/////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/businessAdmin/photoUpload.do")
	public String singlePhotoUpload_BusinessAdmin(HttpServletRequest request, HttpServletResponse response, PhotoVO editor) {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/businessAdmin/multiplePhotoUpload.do")
	public void multiplePhotoUpload_BusinessAdmin(HttpServletRequest request, HttpServletResponse response) {
		try {
			// 파일정보
			String sFileInfo = "";
			// 파일명을 받는다 - 일반 원본파일명
