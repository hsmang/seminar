...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView getBoardList(String pageNumber, String pageSize, String search_value, String search_type, HttpServletResponse response, HttpServletRequest request, HttpSession session) throws Exception{
		...
		if(search_value == null && search_type == null){
			...
			ModelAndView mv = new ModelAndView("/board/board/board");
...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView getBoardDetail(int board_idx, String f_type, HttpSession session, HttpServletRequest request, HttpServletResponse response) throws Exception{
		ModelAndView mv = new ModelAndView("/board/board/board_detail");
	...
	public String insertBoardReply(HttpSession session, ReplyVO reply ,HttpServletRequest request, int board_idx, String f_type) throws Exception{
		UserVO user = (UserVO) session.getAttribute("user");
		reply.setBoard_idx(board_idx);
		reply.setF_type(f_type);
		...
		return "redirect:/board/detail.do?board_idx="+board_idx+"&f_type="+f_type;
	}
	
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/board/deleteReplyProc.do")
	public String deleteBoardReply(HttpServletRequest request, int reply_idx) throws Exception {
...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView updateBoardDetail(int board_idx) throws Exception{
		ModelAndView mv = new ModelAndView("/board/board/board_update");
...
///////////////////////////////////////////////////////////////////////////////
	 ...
	 * boardVO 매개변수로 다 받음
	 */
	@RequestMapping(value = "/board/updateProc.do")
	public String updateProcBoardDetail(BoardVO board, HttpServletRequest request) throws Exception{
...
///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/board/deleteProc.do")
	public String deleteBoardDetail(int board_idx) throws Exception{
...
///////////////////////////////////////////////////////////////////////////////
	...
	public String insertBoard() throws Exception{
		...
		return "/board/board/board_insert";
	}
	
///////////////////////////////////////////////////////////////////////////////
	
	@RequestMapping(value = "/board/insertProc.do")
	public String insertProcBoard(BoardVO board, HttpServletRequest request, HttpSession session) throws Exception{
		UserVO user = (UserVO) session.getAttribute("user");
