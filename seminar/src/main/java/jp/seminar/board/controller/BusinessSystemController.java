...
public class BusinessSystemController {
	///////////////////////////////////////////////////////////////////////////////
	@Resource(name = "businessSystemService")
	private BoardService boardService;

	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessSystem.do")
	public ModelAndView getBusinessSystemBoardList(String pageNumber, String pageSize, String search_value,
		...
		if (search_value == null && search_type == null) {
			...
			ModelAndView mv = new ModelAndView("/board/businessSystem/businessSystem");
	...
	@RequestMapping(value = "/businessSystem/detail.do", method = RequestMethod.GET)
	public ModelAndView getBusinessSystemBoardDetail(int board_idx, String f_type, HttpSession session,
			HttpServletRequest request, HttpServletResponse response) throws Exception {
		ModelAndView mv = new ModelAndView("/board/businessSystem/businessSystem_detail");
	...
	@RequestMapping(value = "/businessSystem/fileDownload.do")
	public ModelAndView fileDownload_BusinessSystem(@RequestParam("filePath") String filePath) throws Exception {
		String path = filePath;
		File downloadFile = new File(path);
		return new ModelAndView("fileDownloadView", "downloadFile", downloadFile);
	}

	@RequestMapping(value = "/businessSystem/insertReply.do")
	public String insertBusinessSystemReply(HttpSession session, ReplyVO reply, HttpServletRequest request, int board_idx, String f_type)
			throws Exception {
		UserVO user = (UserVO) session.getAttribute("user");
		reply.setBoard_idx(board_idx);
		reply.setF_type(f_type);
		...
		return "redirect:/businessSystem/detail.do?board_idx=" + board_idx + "&f_type=" + f_type;
	}
	
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessSystem/deleteReplyProc.do")
		public String deleteBusinessSystemReply(HttpServletRequest request, int reply_idx) throws Exception {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessSystem/update.do", method = RequestMethod.GET)
	public ModelAndView updateBusinessSystemBoardDetail(int board_idx) throws Exception {
	 ...
	 * boardVO 매개변수로 다 받음
	 */
	@RequestMapping(value = "/businessSystem/updateProc.do")
	public String updateProcBusinessSystemBoardDetail(BoardVO board, HttpServletRequest request) throws Exception {

		boardService.updateBoardDetail(board);

		return "redirect:/businessSystem.do";
	}

	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessSystem/deleteProc.do")
	public String deleteBusinessSystemBoardDetail(int board_idx) throws Exception {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/businessSystem/insert.do")
	public String insertBusinessSystemBoard() throws Exception {

		return "/board/businessSystem/businessSystem_insert";
	}

	///////////////////////////////////////////////////////////////////////////////

	@RequestMapping(value = "/businessSystem/insertProc.do")
	public String insertProcBusinessSystemBoard(BoardVO board, HttpServletRequest request, HttpSession session)
			throws Exception {
		UserVO user = (UserVO) session.getAttribute("user");
	...
	@RequestMapping(value = "/businessSystem/fileUpload.do")
	@ResponseBody
	public Map<String, String> fileUpload_BusinessSystem(HttpServletRequest request, FileVO filevo, String board_idx)
			throws Exception {
	...
	@RequestMapping(value = "/businessSystem/fileDelete.do")
	@ResponseBody
	public Map<String, String> fileDelete_BusinessSystem(String name, int index) throws Exception {
		FileVO fileinfo = new FileVO();
	...
	/////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/businessSystem/photoUpload.do")
	public String singlePhotoUpload_BusinessSystem(HttpServletRequest request, HttpServletResponse response, PhotoVO editor) {
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/businessSystem/multiplePhotoUpload.do")
	public void multiplePhotoUpload_BusinessSystem(HttpServletRequest request, HttpServletResponse response) {
		try {
			// 파일정보
			String sFileInfo = "";
			// 파일명을 받는다 - 일반 원본파일명
