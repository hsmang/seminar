...
public class AlbumController {
	...
	public String insertAlbumReply(HttpSession session, ReplyVO reply, HttpServletRequest request, int board_idx, String f_type)
			throws Exception {
		UserVO user = (UserVO) session.getAttribute("user");
		reply.setBoard_idx(board_idx);
		reply.setF_type(f_type);
	...
	///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/album/deleteReplyProc.do")
	public String deleteAlbumReply(HttpServletRequest request, int reply_idx) throws Exception {
