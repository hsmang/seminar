...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView getProductBoardList(String pageNumber, String pageSize, String search_value, String search_type, HttpServletResponse response, HttpServletRequest request, HttpSession session) throws Exception{
...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView getProductBoardDetail(int board_idx, String f_type, HttpSession session, HttpServletRequest request, HttpServletResponse response) throws Exception{
		ModelAndView mv = new ModelAndView("/seminar/product/product_detail");
	...
	@RequestMapping(value = "/product/fileDownload.do")
	public ModelAndView fileDownload_Product(@RequestParam("filePath") String filePath) throws Exception {
...
///////////////////////////////////////////////////////////////////////////////
	...
	public ModelAndView updateProductBoardDetail(int board_idx) throws Exception{
		ModelAndView mv = new ModelAndView("/seminar/product/product_update");
...
///////////////////////////////////////////////////////////////////////////////
	 ...
	 * boardVO 매개변수로 다 받음
	 */
	@RequestMapping(value = "/product/updateProc.do")
	public String updateProcProductBoardDetail(BoardVO board, HttpServletRequest request) throws Exception{
...
///////////////////////////////////////////////////////////////////////////////
	@RequestMapping(value = "/product/deleteProc.do")
	public String deleteProductBoardDetail(int board_idx) throws Exception{
...
///////////////////////////////////////////////////////////////////////////////
	...
	public String insertProductBoard() throws Exception{
		
		return "/seminar/product/product_insert";
	}
...
///////////////////////////////////////////////////////////////////////////////
	...
	@RequestMapping(value="/product/fileUpload.do")
	@ResponseBody
	public Map<String,String> fileUpload_Product(HttpServletRequest request, FileVO filevo, String board_idx) throws Exception  {
	...
	@RequestMapping(value="/product/fileDelete.do")
	@ResponseBody
	public Map<String,String> fileDelete_Product(String name, int index) throws Exception  {
		FileVO fileinfo = new FileVO();
	...
	/////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/product/photoUpload.do") 
	public String singlePhotoUpload_Product(HttpServletRequest request, HttpServletResponse response, PhotoVO editor){ 
...
///////////////////////////////////////////////////////////////////////////////
	@RequestMapping("/product/multiplePhotoUpload.do")
	public void multiplePhotoUpload_Product(HttpServletRequest request, HttpServletResponse response) {
		try {
	         //파일정보
	         String sFileInfo = "";
	         //파일명을 받는다 - 일반 원본파일명
