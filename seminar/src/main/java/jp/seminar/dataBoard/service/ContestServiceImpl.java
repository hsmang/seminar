package jp.seminar.dataBoard.service;
...
import jp.seminar.dataBoard.dao.ContestDAOImpl;
import jp.seminar.paging.FirstRowPageSize;

@Service("contestService")
public class ContestServiceImpl implements DataBoardService {
	
	@Resource(name="contestDao")
	private ContestDAOImpl boardDAO;
